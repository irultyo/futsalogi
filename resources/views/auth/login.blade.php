                        ...
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('no_hp') ? ' has-danger' : '' }} mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('no_hp') ? ' is-invalid' : '' }}" placeholder="{{ __('No HP') }}" type="text" name="no_hp" value="{{ old('no_hp') }}" value="admin@argon.com" required autofocus>
                                </div>
                                @if ($errors->has('no_hp'))
